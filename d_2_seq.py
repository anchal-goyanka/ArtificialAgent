...
print less_verbs, 'verbs in wordnet'
#print len(less_verbs)
print verbs_not_in_wordnet, 'verbs not in wrodnet'
#print len(verbs_not_in_wordnet)
...
tfile = open('verb_clusters.txt', 'w')
